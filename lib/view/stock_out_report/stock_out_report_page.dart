    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(title,
              style:
              const TextStyle(fontSize: 16, fontWeight: FontWeight.w900, color: Color(0xFF111827))),
          const SizedBox(height: 12),
          Container(
          ...
          if (rows.isEmpty)
            const Padding(
              ...
              child: Center(
                child: Text('No data',
                    style:
                    TextStyle(color: Color(0xFF9CA3AF), fontWeight: FontWeight.w700)),
              ),
            )
          else
                    ...
                    return Expanded(
                      ...
                      child: j == 3
                        ...
                        child: r[j],
                          ...
                          : Align(
                        alignment:
                        j == 4 ? Alignment.centerRight : Alignment.centerLeft,
                        child: r[j],
                      ),
                    );
                  }),
